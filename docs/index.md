...
> ⚠️ **This documentation may be partially out of date as of version 1.2+**
...
```bash
pip install git+https://github.com/alx0rr/kyodo.git
```
...
```bash
git clone https://github.com/alx0rr/kyodo.git
cd repository
```
